...
public interface ControllerDocumentationConstants {
    ...
    String WIDGET_NOT_FOUND = "Widget with provided id not found";
    String EMPTY_WIDGET_STORAGE = "Empty widget storage";

    String WIDGET_CREATED_UNSUCCESSFULLY = "Widget created unsuccessfully";
    String WIDGET_ID_VALIDATION_EXCEPTION = "";

    String INTERNAL_SERVER_ERROR = "Internal server error";

    String WIDGET = "Widget";
    String WIDGET_UUID = "Id";
